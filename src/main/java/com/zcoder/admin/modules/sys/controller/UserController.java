...
import com.zcoder.admin.modules.core.utils.ValidateCodeUtils;
...
import com.zcoder.admin.modules.sys.service.UserService;
...
public class UserController extends BaseController {
   ...
   /* @ModelAttribute
    ...
    @ResponseBody
    public Map<String, Object> findAll(User user, HttpServletRequest request) {
        Page<User> page = userService.findAll(getPage(request), user);
